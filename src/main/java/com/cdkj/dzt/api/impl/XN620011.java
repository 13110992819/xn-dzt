...
import com.cdkj.dzt.dto.req.XN620011Req;
 ...
 * @history:
 */
public class XN620011 extends AProcessor {
    private IModelAO modelAO = SpringContextHolder.getBean(IModelAO.class);

    private XN620011Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN620011Req.class);
