...
import com.cdkj.dzt.dto.req.XN620917Req;
 ...
 * @history:
 */
public class XN620917 extends AProcessor {
    private ISYSConfigAO sysConfigAO = SpringContextHolder
        .getBean(ISYSConfigAO.class);

    private XN620917Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN620917Req.class);
