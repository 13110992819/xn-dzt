...
INSERT INTO `tstd_account` (`account_number`,`user_id`,`real_name`,`type`,`status`,`currency`,`amount`,`frozen_amount`,`md5`,`add_amount`,`in_amount`,`out_amount`,`create_datetime`,`last_order`,`system_code`) VALUES ('DZTA2017100000000000000','SYS_USER_DZT','平台','P','0','CNY',0,0,'33b28c846c000b153bc34f7f3563c631',0,0,0,now(),'AJ2017041920073612859','CD-CDZT000009');
