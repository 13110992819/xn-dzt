...
CREATE TABLE `tdzt_cloth` (
  ...
  `model_specs_code` varchar(32) DEFAULT NULL COMMENT '模板品种编号',
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tdzt_craft` (
  ...
  `location` varchar(32) DEFAULT NULL COMMENT 'UI位置',
  `order_no` int(11) DEFAULT NULL COMMENT 'UI顺序',
  `is_hit` varchar(32) DEFAULT NULL COMMENT '是否撞色',
  `is_default` varchar(32) DEFAULT NULL COMMENT '是否默认数据',
  `status` varchar(4) DEFAULT NULL COMMENT '状态',
  `updater` varchar(32) DEFAULT NULL COMMENT '更新人',
  `update_datetime` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` text COMMENT '备注',
...
CREATE TABLE `tdzt_model` (
  `code` varchar(32) NOT NULL COMMENT '编号',
  `kind` varchar(32) DEFAULT NULL COMMENT '分类',
  `type` varchar(32) DEFAULT NULL COMMENT '类型',
  `name` varchar(255) DEFAULT NULL COMMENT '名称',
  `pic` text COMMENT '图片',
  `adv_pic` text COMMENT '广告图',
...
CREATE TABLE `tdzt_order` (
  ...
  `order_product` varchar(32) DEFAULT NULL COMMENT '下单产品',
...
DROP TABLE IF EXISTS `tdzt_order_size_data`;
CREATE TABLE `tdzt_order_size_data` (
...
DROP TABLE IF EXISTS `tdzt_product_craft`;
CREATE TABLE `tdzt_product_craft` (
  ...
  `selected` text COMMENT '缩率图',
  `price` bigint(20) DEFAULT NULL COMMENT '工艺费',
  `model_specs_code` varchar(32) DEFAULT NULL COMMENT '模型编号',
  `product_var_code` varchar(32) DEFAULT NULL COMMENT '成衣品种编号',
  `order_code` varchar(32) DEFAULT NULL COMMENT '订单编号'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `tdzt_product_var`;
CREATE TABLE `tdzt_product_var` (
  `code` varchar(32) NOT NULL COMMENT '编号',
  `name` varchar(255) DEFAULT NULL COMMENT '名称',
  `pic` text COMMENT '图片',
  `updater` varchar(32) DEFAULT NULL COMMENT '更新人',
  `update_datetime` datetime DEFAULT NULL COMMENT '更新时间',
  `product_code` varchar(32) DEFAULT NULL COMMENT '成衣编号',
  `model_specs_code` varchar(32) DEFAULT NULL COMMENT '产品编号',
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `tdzt_specimen`;
CREATE TABLE `tdzt_specimen` (
  `code` varchar(32) NOT NULL COMMENT '编号',
  `pic` text COMMENT '图片',
  `adv_pic` text COMMENT '广告图',
  `description` text COMMENT '图文描述',
...
DROP TABLE IF EXISTS `tsys_product_category`;
CREATE TABLE `tsys_product_category` (
  `code` varchar(32) NOT NULL COMMENT '编号（自增长）',
  `kind` varchar(32) DEFAULT NULL COMMENT '分类（0工艺，1刺绣）',
  `type` char(1) DEFAULT NULL COMMENT '类型（第一层/第二层）',
  `parent_key` varchar(32) DEFAULT NULL COMMENT '父key',
  `dkey` varchar(32) DEFAULT NULL COMMENT 'key',
  `dvalue` varchar(255) DEFAULT NULL COMMENT '值',
